...
export function Post({ _id, title, summary, cover, createdAt, author }) {
    return (
        <div className="w-full max-w-4xl mx-auto my-6 p-4 md:p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
